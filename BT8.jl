...
# ╔═╡ 5f383cd0-ee32-11ed-3fee-4d4c3bba1997
using MLDatasets:MNIST

# ╔═╡ bcfc9941-008d-4426-a759-3b98cee9606a
using ImageShow

# ╔═╡ 409daae6-d5fb-474d-8e82-101df2b4006f
using ImageIO

# ╔═╡ 808ffbc0-fbef-45d0-bc5c-ea51688ed8b7
using ImageInTerminal

# ╔═╡ 3bedbac9-2235-4237-82dd-095f31643d6c
using Flux

# ╔═╡ 66a3c200-6587-4cbd-8977-93012c306c9f
dataset = MNIST(:train)

# ╔═╡ 16dc9348-dbc5-4c15-bd3b-97b25a99896a
X = dataset.features[:,:,1:2000]

# ╔═╡ 3c9ac1e6-68d0-4d2b-bbf9-9b6a39e9f47a
x1 = X[:,:,1]

# ╔═╡ 5a6f4412-0075-4e7b-8c9f-195d191f0a3d
MNIST.convert2image(x1)

# ╔═╡ 8f9c7807-6a83-47b1-9e11-16f32ebf723f
[MNIST.convert2image(X[:,:,i]) for i=1:5]

# ╔═╡ 28987fbd-1239-4f9c-81b8-9fa5873cac8c
y = dataset.targets[1:2000]

# ╔═╡ 169470d0-7b79-426b-993c-48f8456bad8e
y[1:5]

# ╔═╡ 457ccd75-0fa7-4659-af7f-707e02ed17ea
layer1 = Dense(5 => 3)

# ╔═╡ c5eefc12-a099-46ff-98c9-2a006de5778b
layer1.bias

# ╔═╡ 6f1e8ab9-5863-4c18-978a-a9aa0e4ca4f6
layer1.weight

# ╔═╡ b56eb9d4-f499-4a77-b300-4277121edacd
layer1.σ

# ╔═╡ 6c1fb29e-b92d-4eb2-bd08-f243550e3012
u = Float32.(rand(5))

# ╔═╡ e79d5182-e524-48b3-94b6-54be755572b1
layer1(u)

# ╔═╡ 207020eb-c9ea-4c4d-9658-650460e4c2c2
layer1.weight * u + layer1.bias

# ╔═╡ d1a6f177-b7b0-466e-9eec-14f8ff412d2e
layer2 = Dense(5, 2, σ)

# ╔═╡ 54fc5a28-a39a-4675-be47-e16443994a25
layer2(u)

# ╔═╡ 3f94ff59-4904-4a2a-9f9c-b58bb29af7ad
layer2.σ(layer2.weight * u + layer2.bias)

# ╔═╡ bc76dd0b-6b71-4d44-adea-a8fd467294bb
l1 = Dense(28*28, 64, tanh)

# ╔═╡ a61ef6f5-b1f8-47a2-982b-03a615ccbcdb
x1[:]

# ╔═╡ 4f18fda4-5d65-4bcc-bb96-baadb0db8e88
l1(x1[:])

# ╔═╡ 02249930-3e2e-4ace-bba0-3fb8557317fa
a1 = l1(x1[:])

# ╔═╡ 978f47a3-a5fc-4e52-9ef9-378bb2f5c89e
l2 = Dense(64, 32, relu)

# ╔═╡ bf0a3336-0a31-429d-a752-93928ae12263
a2 = l2(a1)

# ╔═╡ be88b7a0-2320-4521-be1a-220ddb0dd1f2
network = Chain(l1, l2, Dense(32, 10), softmax)

# ╔═╡ 91bd696c-e618-4c75-ae5a-dc046117c39c
network(x1[:])

# ╔═╡ c3b039bd-ba0e-4f2b-bef3-8a50bae90fb3
network(X[:,:,2][:])

# ╔═╡ 218c3961-de43-49cb-b18f-f85accd99257
y[1]

# ╔═╡ 18e78cd1-3771-4957-9936-ea9b2ff575bd
ŷ1 = network(x1[:])

# ╔═╡ f36bef77-afda-4d33-9471-eb927bc9aa6c
y1 = Flux.onehot(y[1], 0:9)

# ╔═╡ 5af1568f-5c75-4472-885e-cb556d7f0443
loss(ŷ, y) = Flux.crossentropy(ŷ, y)

# ╔═╡ 11729a0b-5df9-47e8-89ca-8556b47fc2f5
loss(ŷ1, y1)

# ╔═╡ b1031090-7dd4-4014-ac0a-d83b8b48397d
loss(network(X[:,:,2][:]), Flux.onehot(y[2], 0:9))

# ╔═╡ 1b7cdd75-b5c8-4706-8873-0c5bbd7b94ce
X8 = zeros(28*28, 8)

# ╔═╡ 07fd56b4-61ac-4ea4-b3b4-408a08613270
for i=1:8
	X8[:,i] = X[:,:,i][:]
end

# ╔═╡ 15dad0c9-7521-4bc3-a5fd-594b8b1b0ff8
sum(X8, dims=1)

# ╔═╡ d0c05f5c-257c-49d4-b21c-8cab345232fc
l1(X8)

# ╔═╡ 43833463-8d7a-4524-bd85-5c38c6d098f8
ŷ8 = network(X8)

# ╔═╡ 1d8c4e35-2753-4033-bd5c-4c9391452771
y[1:8]

# ╔═╡ 43b2e198-1ab7-4eab-9831-253328c24be9
y8 = Flux.onehotbatch(y[1:8], 0:9)

# ╔═╡ d38f2890-51ab-44bf-8c4e-bac03978b813
loss(ŷ8, y8)

# ╔═╡ b8b8bc66-69a7-41f3-ba19-5cbd575e4db6
ŷ = [network(X[:,:,i][:]) for i=1:2000]

# ╔═╡ b8680684-3acc-4785-ad18-5508bda1f86b
prediction = Flux.stack(ŷ)

# ╔═╡ dda65f19-c83b-4292-8765-fcc16ff4c3ea
target = Flux.onehotbatch(y, 0:9)

# ╔═╡ 51b9f9c3-d1a8-490e-8ddc-d970c493c90e
loss(prediction, target)

# ╔═╡ 4b6b18d7-afb5-4ae1-a676-975b6638eb90
sum(Flux.onecold(prediction) .== y)/length(y)

# ╔═╡ 4410f23f-eef8-4d8c-8ce7-be4a2b34d6a0
X_train = [X[:,:,i][:] for i=1:2000]

# ╔═╡ b3d3229c-1c57-4bcc-a80f-4efba2b519f3
y_train = [Flux.onehot(y[i], 0:9) for i=1:2000]

# ╔═╡ f0a95d44-9695-4af6-b350-b6d8e8f87559
data = zip(X_train, y_train)

# ╔═╡ e28a60f1-86e0-43fb-af13-16a9bb303a5a
optimizer = Adam()

# ╔═╡ 87b8386b-b083-469a-a3e0-28e5f48db962
θ = Flux.params(network)

# ╔═╡ fe371fe2-6b43-4d2f-a05e-1bcd0af84a7c
opt_state = Flux.setup(optimizer, network)

# ╔═╡ a330a005-b80e-414a-aaf4-738df7194a85
cost(model, x, target) = Flux.conssentropy(model(x), target)

# ╔═╡ be4013f4-5208-4f3e-bd5d-888270db27a4
Flux.@epochs 10 Flux.train!(cost, network, data, opt_state)

# ╔═╡ 9c7b8ee7-ff03-4603-bff3-b4e490616d19
collect(data)

# ╔═╡ e08b04f9-2382-408a-80ce-4d3278465df3
z = [Flux.onecold(network(X_train[i])) for i=1:2000]

# ╔═╡ 299a51f1-78df-472a-a122-1251f343044d
sum(z .== (y .+ 1))/2000
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "c9d219042a511b63be8e7a913c87fea8d170be00"
